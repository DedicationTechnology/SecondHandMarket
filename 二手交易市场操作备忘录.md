...
15. ModuleNotFoundError: No module named 'mutagen._compat'
    ...
    ![BS39](https://raw.githubusercontent.com/DedicationTechnology/picgo/master/img/BS39.png)
...
22. 修改表中的每一条数据在admin中的显示
    ...
    ![BS40](https://raw.githubusercontent.com/DedicationTechnology/picgo/master/img/BS40.png)

    需要修改的内容

    ![BS41](/Volumes/MacData/Snipaste/photoFile/BS41.png)

    修改后的显示

    ![BS42](https://raw.githubusercontent.com/DedicationTechnology/picgo/master/img/BS42.png)

23. ps中拓展图片到指定画布大小

    - 保存要拓展的图像并命名

    ![BS43](/Volumes/MacData/Snipaste/photoFile/BS43.png)

    - 新建一个指定像素大小的画布并点击图层上面的锁按钮使其消失
    - 进行图层叠加

    ![BS46](/Volumes/MacData/Snipaste/photoFile/BS46.png)

    - 选择要叠加的图层并进行调整大小

    ![BS47](/Volumes/MacData/Snipaste/photoFile/BS47.png)

    ![BS48](/Volumes/MacData/Snipaste/photoFile/BS48.png)
...
24. 设置mysql数据库的事务的隔离级别
    ...
    ![BS49](/Volumes/MacData/Snipaste/photoFile/BS49.png)
...
25. 连接支付宝付款接口时常见的报错
    ...
    -  alipay.api_alipay_trade_page_pay报错type error: quote_from_bytes() expected bytes
      ...
      ![](/Volumes/MacData/Snipaste/photoFile/BS50.png)
...
27. 支付宝跳转支付页面显示【错误代码 invalid-signature 错误原因: 验签出错，建议检查签名字符串或签名私钥与应用公钥是否匹配】，首先考虑代码中添加的公钥是支付宝的公钥而不是应用的公钥，私钥是应用的私钥，如果发现不是这个错误则判断以下代码是否书写错误
    ...
    ![BS51](/Volumes/MacData/Snipaste/photoFile/BS51.png)
